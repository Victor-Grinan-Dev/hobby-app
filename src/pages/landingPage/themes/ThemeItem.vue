<template>
    <div className="group relative overflow-hidden md:w-1/4">
        <img :src="theme.desktopImg" :alt="theme.id" class='w-full hidden md:block group-hover:scale-110 duration-200'>

        <img :src="theme.mobileImg" :alt="theme.id" class='md:hidden w-full'>
        <div
