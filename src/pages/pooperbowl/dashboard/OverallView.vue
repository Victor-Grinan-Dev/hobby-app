<template>
    <div class='flex flex-wrap justify-center gap-4 w-full'>
        <div class='flex flex-col'>
            <barchart-horizontal orientation='h' :title='title' :data='monthlyGames' :max='16' :chartWidth='200'
                :textParams='monthlyGames.months' :numericParams='monthlyGames.playedGames' :type='"percent"'
                :colors='["#3d9970"]' />
        </div>
        <div class='flex flex-col'>
            <barchart-horizontal orientation='v' :title='title' :data='monthlyGames' :max='16' :chartWidth='200'
                :textParams='monthlyGames.months' :numericParams='monthlyGames.playedGames' :type='"percent"'
