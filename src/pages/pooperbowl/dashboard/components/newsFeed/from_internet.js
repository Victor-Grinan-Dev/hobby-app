    ...
    return (
      <div id="header">
        {this.state.sideMenuVisible ? (
          <div className="overlay" onClick={this.hideSideMenu}></div>
        ) : (
          ""
        )}
        <div
            ...
            <div className="app-title">
              {this.props.isMobile ? (
                <div className="side-menu-button">
                  <a href="#" onClick={this.showSideMenu}>
    ...
    return (
      <div className="right-side">
        <div className="controls" onChange={this.props.change}>
          ...
          <div
            className="toggle-wrap"
            title="Page doesn't jump when you scroll down (more than half screen)"
          >
          ...
          <div
            className="toggle-wrap"
            title="If max posts count exceeded, oldest automatically replaced"
          >
